...
async function main() {
  await mongoose.connect('mongodb+srv://admin-warsay:Warsay123q@warsay0.j5jxsjf.mongodb.net/journalDB');
}
...
app.post("/compose", function(req, res){
  ...
  Journal.find({}, function(err, postArray){
    if(!err){
      postArray.push(post);
      postArray.save();
